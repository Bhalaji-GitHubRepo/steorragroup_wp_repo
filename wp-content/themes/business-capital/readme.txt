...
Business Capital includes support for Infinite Scroll in Jetpack, Breadcrunb NXT for advanced breadcrumb solution.

== Changelog ==

= 1.0.3 - 22 June, 2022 =
* Update: Hosted Google fonts locally (https://make.wordpress.org/themes/2022/06/18/complying-with-gdpr-when-using-google-fonts/)
...
* Webfonts Loader: [MIT] https://github.com/WPTT/webfont-loader* Webfonts Loader: [MIT] https://github.com/WPTT/webfont-loader

Images
	All images are licensed under [CC0] (https://creativecommons.org/publicdomain/zero/1.0/)
		* Screenshot and header image:		https://www.maxpixel.net/Man-Computer-Desk-Advocacy-Office-Lawyer-5806012
